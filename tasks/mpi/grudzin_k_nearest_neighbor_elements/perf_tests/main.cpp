...
TEST(grudzin_k_nearest_neighbor_elements_mpi, test_pipeline_run) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_ans(1, 0);
  // Create TaskData
  ...
  auto testMpiTaskParallel =
      std::make_shared<grudzin_k_nearest_neighbor_elements_mpi::TestMPITaskParallel>(taskDataPar);
  ...
  if (world.rank() == 0) {
    ...
    ASSERT_EQ(0, global_ans[0]);
  }
}

TEST(grudzin_k_nearest_neighbor_elements_mpi, test_task_run) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
