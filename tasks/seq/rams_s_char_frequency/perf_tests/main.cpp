...
TEST(rams_s_char_frequency_seq_perf_test, test_pipeline_run) {
  ...
  // Create Task
  auto testTaskSequential = std::make_shared<rams_s_char_frequency_seq::CharFrequencyTaskSequential>(taskDataSeq);
...
TEST(rams_s_char_frequency_seq_perf_test, test_task_run) {
  std::string common_string = "abc";
  std::string in;
  for (int i = 0; i < 999999; i++) {
    in += common_string;
